...
//        }
    ...
    private void sendErrorToClient(ChannelHandlerContext ctx, HttpResponseStatus statu) {
        ByteBuf buf = Unpooled.copiedBuffer(("Error: " + statu.toString() + CRLF).getBytes());
        FullHttpResponse resp = new DefaultFullHttpResponse(HTTP_1_1, statu, buf);
